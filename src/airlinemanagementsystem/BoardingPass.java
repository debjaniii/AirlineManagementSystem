...
public class BoardingPass extends JFrame implements ActionListener{
    ...
    public BoardingPass() {
        ...
        JLabel heading = new JLabel("CLOUD9 AIRLINES");
        heading.setBounds(350, 20, 450, 35);
        heading.setFont(new Font("TIMES NEW ROMAN", Font.BOLD, 32));
        add(heading);
        
        JLabel subheading = new JLabel("Boarding Pass");
        subheading.setBounds(420, 70, 300, 30);
        subheading.setFont(new Font("TIMES NEW ROMAN", Font.BOLD, 24));
        ...
        tfpnr.setBounds(220, 120, 150, 25);
        add(tfpnr);
        ...
        lblgender.setBounds(380, 240, 150, 25);
        lblgender.setFont(new Font("Tahoma", Font.PLAIN, 16));
        add(lblgender);
        
        lbldest = new JLabel();
        lbldest.setBounds(540, 240, 150, 25);
        add(lbldest);
        ...
        lblimage.setBounds(500, 100, 500, 300);
        add(lblimage);
